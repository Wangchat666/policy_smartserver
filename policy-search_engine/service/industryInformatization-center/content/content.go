...
type IndustryInformatizationContentColly struct {
	rules []*service.Rule
	// 等待处理的url队列
...
func (s *IndustryInformatizationContentColly) Init() {
	// 注册规则
...
// Import 分批次导入
func (s *IndustryInformatizationContentColly) Import() (success bool) {
...
func (s *IndustryInformatizationContentColly) Run() {
...
func (s *IndustryInformatizationContentColly) Destroy() {
	s.rules = nil
	s.metaDal = nil
	s.contentDal = nil
	s.waitQueue = nil
...
func (s *IndustryInformatizationContentColly) ExecuteWorkflow() {
	s.Init()
	if s.Import() {
		s.Run()
	}
...
var _ service.ContentCrawler = (*IndustryInformatizationContentColly)(nil)
